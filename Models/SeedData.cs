...
namespace PharmaStire_PS.Models
{
    public static class SeedData
    {
        public static void EnsurePopulated(IApplicationBuilder app)
        {
            ...
            //Метод EnsurePopulated получает объект ApplicationDbContext
            //    через интерфейс IApplicationBuilder и вызывает метод
            //    Database.Migrate(), чтобы гарантировать применение миграции,
            //    что означает создание и подготовку базы данных к хранению объектов Product.
